...
### Removed
 ...
 - Support for the old dispatching: `#[ronami(subtransition)]` [**BC**].

### Deprecated

 - `#[derive(DialogueState)]` in favour of `ronami::handler!`.
...
### Changed
 ...
 - Adjust dialogues with the latest ronami (v0.4.0).

## 0.3.2 - 2020-07-27

### Added
 - `#[derive(Transition)]` with `#[ronami(subtransition)]`.
...
### Changed
 - The description in `Cargo.toml` was changed to from "The ronami's macros for internal usage" to "The ronami's procedural macros".
