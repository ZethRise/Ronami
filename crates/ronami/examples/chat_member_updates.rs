use ronami::{prelude::*, types::ParseMode, utils::html};
use ronami_core::adaptors::DefaultParseMode;
...
///
/// [requester adaptor]: ronami::requests::Requester#adaptors
type Bot = DefaultParseMode<ronami::Bot>;
...
async fn main() -> ResponseResult<()> {
    ...
    // `html::user_mention`
    let bot = ronami::Bot::from_env().parse_mode(ParseMode::Html);
