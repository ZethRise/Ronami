    ...
    Err: Debug + Send + Sync + 'static,
{
    ...
    ///
    /// This is why `ronami` allows grouping updates. Updates for which the
    ...
    ///
    /// ```
    /// use ronami::{dispatching::Dispatcher, dptree, Bot};
    ///
    ...
    pub fn build(self) -> Dispatcher<R, Err, Key> {
        ...
        dptree::type_check(
            ...
            &[
                dptree::Type::of::<R>(),
                dptree::Type::of::<ronami_core::types::Update>(),
                dptree::Type::of::<ronami_core::types::Me>(),
            ],
        );
