...
//!
//! ```
//! use ronami::utils::command::parse_command;
//!
...
//!
//! ```
//! use ronami::utils::command::parse_command_with_prefix;
//!
...
//!
//! [examples/admin]: https://github.com/teloxide/teloxide/blob/master/crates/ronami/examples/admin.rs
...
use ronami_core::types::{BotCommand, Me};
#[cfg(feature = "macros")]
pub use ronami_macros::BotCommands;
...
/// ```
/// # #[cfg(feature = "macros")] {
/// use ronami::utils::command::{BotCommands, ParseError};
///
...
impl<'a> CommandDescriptions<'a> {
    ...
    ///
    /// ```
    /// use ronami::utils::command::{CommandDescription, CommandDescriptions};
    ///
