...
/// ## Examples
/// ```
/// use ronami::error_handlers::OnError;
///
/// # #[tokio::main]
/// # async fn main_() {
/// // Prints nothing
...
/// ```
/// use ronami::error_handlers::{IgnoringErrorHandler, OnError};
///
/// # #[tokio::main]
/// # async fn main_() {
/// let err: Result<i32, i32> = Err(404);
...
/// # #[tokio::main]
/// # async fn main_() {
/// use ronami::error_handlers::{ErrorHandler, IgnoringErrorHandler};
///
...
///
/// use ronami::error_handlers::{ErrorHandler, IgnoringErrorHandlerSafe};
///
...
///
/// ```compile_fail
/// use ronami::dispatching::{ErrorHandler, IgnoringErrorHandlerSafe};
///
...
/// # #[tokio::main]
/// # async fn main_() {
/// use ronami::error_handlers::{ErrorHandler, LoggingErrorHandler};
///
