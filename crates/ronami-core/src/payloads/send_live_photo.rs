...
impl_payload! {
    ...
    pub SendLivePhoto (SendLivePhotoSetters) => Message {
        required {
            ...
            /// Live photo video to send. The video must be no longer than 10 seconds and must not exceed 10 MB in size. Pass a file_id as FileId to send a video that exists on the Telegram servers (recommended) or upload a new video using multipart/form-data. [More info on Sending Files »]. Sending live photos by a URL is currently unsupported.
            ///
            /// [More info on Sending Files »]: crate::types::InputFile
            pub live_photo: InputFile,
            /// The static photo to send. Pass a file_id as FileId to send a photo that exists on the Telegram servers (recommended) or upload a new video using multipart/form-data. [More info on Sending Files »]. Sending live photos by a URL is currently unsupported.
            ///
            /// [More info on Sending Files »]: crate::types::InputFile
            pub photo: InputFile,
        }
        optional {
            ...
            /// Unique identifier for the target message thread (topic) of the forum; for forum supergroups and private chats of bots with forum topic mode enabled only
