...
impl_payload! {
    ...
    pub GetChatGifts (GetChatGiftsSetters) => OwnedGifts {
        ...
        optional {
            /// Pass _true_ to exclude gifts that aren't saved to the chat's profile page
            pub exclude_unsaved: bool,
            /// Pass _true_ to exclude gifts that are saved to the chat's profile page
            ...
            /// Pass _true_ to sort results by gift price instead of send date
