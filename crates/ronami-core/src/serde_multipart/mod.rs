...
mod tests {
    ...
    async fn test_send_media_group() {
        ...
        to_form_ref(&payloads::SendMediaGroup::new(
            ...
            [
                InputMedia::Photo(
                    InputMediaPhoto::new(InputFile::file("../../media/ronami-core-logo.png"))
                        .caption(CAPTION)
                ...
                InputMedia::Animation(
                    ...
                    .thumbnail(InputFile::read(
                        File::open("../../media/ronami-core-logo.png").await.unwrap(),
                    ))
                    .duration(17),
                ),
                InputMedia::Audio(
    ...
    async fn test_send_animation() {
        to_form_ref(
            &payloads::SendAnimation::new(
                ChatId(0),
                InputFile::file("../../media/ronami-core-logo.png"),
            )
            .caption_entities(entities())
            .thumbnail(InputFile::read(
                File::open("../../media/ronami-core-logo.png").await.unwrap(),
