...
///
/// ```rust
/// use ronami_core::types::{File, FileId, FileUniqueId};
/// #
/// # let get_file = || File { meta: ronami_core::types::FileMeta { id: FileId(String::new()), unique_id: FileUniqueId(String::new()), size: 0 }, path: String::new() };
