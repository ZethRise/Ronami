...
/// [`Filter`], etc) that wrap an [`Iterator`] and alter its behaviour, Ronami
...
///
/// ```compile_fail
/// # use ronami_core::{prelude::*, types::{ChatId, ParseMode}};
/// let bot: Bot = Bot::new("TOKEN").parse_mode(ParseMode::Html);
/// ```
/// ```rust
/// # use ronami_core::{prelude::*, types::{ChatId, ParseMode}, adaptors::DefaultParseMode};
...
/// # use ronami_core::{adaptors::{DefaultParseMode, Throttle}, requests::RequesterExt, types::ParseMode};
/// type Bot = DefaultParseMode<Throttle<ronami_core::Bot>>;
///
/// let bot: Bot = ronami_core::Bot::new("TOKEN")
///     .throttle(<_>::default())
///     .parse_mode(ParseMode::Html);
/// # let _ = bot;
/// # };
...
///
/// ```toml
/// ronami_core = { version = "...", features = ["throttle"] }
/// ```
///
